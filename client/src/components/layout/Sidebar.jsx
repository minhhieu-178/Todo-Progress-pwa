    ...
    if (isMobile) {
        return (
            <>
                ...
                {/* Mobile Sidebar */}
                <div className={`
                    fixed top-0 left-0 bottom-0 z-50 w-80 bg-white dark:bg-gray-800 transform transition-transform duration-300
                ...
                `}>
                    ...
                    <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <button
                            ...
                            className="w-full flex items-center px-4 py-3 text-red-600 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                        >
            ...
            <nav className="flex-1 px-6 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                {navItems.map((item) => (
                    <NavLink
                        ...
                        to={item.path}
                        className={({ isActive }) => 
                            `flex items-center px-4 py-3 adaptive-text-muted hover:adaptive-text rounded-lg group transition-all duration-200 hover:bg-white/20 ${isActive ? 'bg-white/30 adaptive-text font-semibold shadow-sm' : ''}`
                        }
                    >
