...
function Sidebar() {
    ...
    const linkClasses = "flex items-center px-4 py-2 text-gray-700 dark:text-[#9fadbc] rounded-lg group transition-colors duration-150 hover:bg-gray-100 dark:hover:bg-white/10";
    
    const activeClasses = "bg-indigo-50 dark:bg-blue-500/10 text-indigo-700 dark:text-[#579dff] font-semibold"; 
    
    return (
        <div className="flex flex-col h-screen w-60 bg-white dark:bg-[#1d2125] border-r border-gray-200 dark:border-white/10 transition-colors duration-200">
        
            <div className="p-6">
                <h1 className="text-xl font-bold text-gray-900 dark:text-[#b6c2cf]">Pro Manage</h1>
            ...
            <div className="p-6 border-t border-gray-200 dark:border-white/10">
                <Link to="/profile" className="flex items-center gap-3 mb-4 hover:bg-gray-100 dark:hover:bg-white/10 p-2 -mx-2 rounded-lg transition-colors cursor-pointer group">
                    ...
                    <div className="overflow-hidden">
                        {/* SỬA: Màu text user */}
                        <p className="text-sm font-semibold text-gray-900 dark:text-[#b6c2cf] truncate">{user?.fullName}</p>
