    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-8 bg-gray-50">
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-sm border border-gray-100">
          ...
          {message.text && (
            <div className={`p-4 mb-6 text-sm rounded-lg ${message.type === 'success' ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-red-50 text-red-700 border border-red-200'}`}>
              {message.text}
            </div>
          )}
